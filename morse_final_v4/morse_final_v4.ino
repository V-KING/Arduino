...
void getMorseSignal(int value,int limit_value  ){
	...
	if( millis() - last_unpress_time>2000 && flag==1){
		...
		if(getMorse==".-") lcd.printstr("A");
		else if(getMorse=="-...") lcd.printstr("B");
		else if(getMorse=="-.-.") lcd.printstr("C");
		else if(getMorse=="-..") lcd.printstr("D");
		else if(getMorse==".") lcd.printstr("E");
		else if(getMorse=="..-.") lcd.printstr("F");
		else if(getMorse=="--.") lcd.printstr("G");
		else if(getMorse=="....") lcd.printstr("H");
		else if(getMorse=="..") lcd.printstr("I");
		else if(getMorse==".---") lcd.printstr("J");
		else if(getMorse=="-.-") lcd.printstr("K");
		else if(getMorse==".-..") lcd.printstr("L");
		else if(getMorse=="--") lcd.printstr("M");
		else if(getMorse=="-.") lcd.printstr("N");
		else if(getMorse=="---") lcd.printstr("O");
		else if(getMorse==".--.") lcd.printstr("P");
		else if(getMorse=="--.-") lcd.printstr("Q");
		else if(getMorse==".-.") lcd.printstr("R");
		else if(getMorse=="...") lcd.printstr("S");
		else if(getMorse=="-") lcd.printstr("T");
		else if(getMorse=="..-") lcd.printstr("U");
		else if(getMorse=="...-") lcd.printstr("V");
		else if(getMorse==".--") lcd.printstr("W");
		else if(getMorse=="-..-") lcd.printstr("X");
		else if(getMorse=="-.--") lcd.printstr("Y");
		else if(getMorse=="--..") lcd.printstr("Z");
		else if(getMorse==".----") lcd.printstr("1");
		else if(getMorse=="..---") lcd.printstr("2");
		else if(getMorse=="...--") lcd.printstr("3");
		else if(getMorse=="....-") lcd.print("4");
		else if(getMorse==".....") lcd.printstr("5");
		else if(getMorse=="-....") lcd.printstr("6");
		else if(getMorse=="--...") lcd.printstr("7");
		else if(getMorse=="---..") lcd.printstr("8");
		else if(getMorse=="----.") lcd.printstr("9");
		else if(getMorse=="-----") lcd.printstr("0");
		else if(getMorse=="..--..") lcd.printstr("?");
		else if(getMorse=="-..-.") lcd.printstr("/");
		else if(getMorse==".-.-.-") lcd.printstr(".");
		else if(getMorse==".--.-.") lcd.printstr("@");
		else if(getMorse=="---.")lcd.print(" ");
                else {lcd.print("ErrInput");delay(1000);lcd.clear();j=0;m=0;}
                getMorse=0;
		n++;
		if(n>=16) n=0;
